...
public class Fragment_FVAnn extends Fragment {
	@Override
		...
		//clickhandler
				calc.setOnClickListener(new OnClickListener() {			
					...
					case 2://cf
						...
						break;
					case 3://r
						Toast errormsg = Toast.makeText(getActivity(), "R cannot be calculated. Sorry!", 5000);
						errormsg.setGravity(Gravity.CENTER, 0, 0);
						errormsg.show();
						break;
					case 4://t
						...
						break;
					default:
						Toast errormsg1 = Toast.makeText(getActivity(), "Error!", 5000);
